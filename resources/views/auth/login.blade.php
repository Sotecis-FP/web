                ...
                <section class="login_content">
                    <form action="{{url('verificar')}}"  method="post">
                      {!!csrf_field()!!}
                        ...
                        <div>
                            <input class="btn btn-default" type="submit" name="" value="Entrar">
                        ...
                        <div class="separator">
                            ...
                            <br />
                            <div>
                                <h1><i class="fa fa-user" style="font-size: 26px;"></i> Flores del prado!</h1>

                                <p>©2018 Flores del Prado</p>
                            </div>
                        </div>
                    </form>
                    <!-- form -->
