...
<form id="demo-form" method="post" action="{{route('producto.actualizar',$producto->id)}}" enctype="multipart/form-data" >
{{ csrf_field() }}
...
<option value="{{$producto->subcategoria->categoria->id}}">{{$producto->subcategoria->categoria->nombre}}</option>
